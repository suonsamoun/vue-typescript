<template>
    <div class="flex items-center justify-between my-2 p-1">
        <div class="flex">
            ...
            <h4
                class="text-xl text-gray-900 leading-tight ml-6"
        ...
        <div class="flex items-center">
            ...
            <svg
                @click="deleteItem()"
                xmlns="http://www.w3.org/2000/svg"
                class="h-6 w-6 ml-3 text-rose-600 cursor-pointer"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
            >
...
export default defineComponent({
    ...
    setup(props) {
        ...
        const toggleCompleted = (): void => {
            commit(MutationTypes.TOGGLE_COMPLETED, props.id);
        };

        const editItem = (): void => {
            commit(MutationTypes.EDIT_ITEM, props);
        };

        const deleteItem = (): void => {
            commit(MutationTypes.DELETE_ITEM, props.id);
        };
